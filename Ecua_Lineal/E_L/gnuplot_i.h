...
/**
 * La función realiza una operación dentro de un rango especificado en los parametros
 * el cual se encarga de imprimir las coordenadas de x , y. La formula es la siguiente:
 * y = mx + b.
 *
 * @brief Imprime las coordenada x, y de la ecuación lineal.
 * @author J.Marcos Iturbide
 * @date 23/11/2020
 * @param m Recibe el valor que multiplicara a x
 * @param b Recibe el valor que sumara el resultado multiplicado por x, para la coordenada y
 * @param rango1 Determina el rango inicial de las coordenadas
 * @param rango2 Determina el rango final de las coordenadas
 * @return void
 */
void imprimirCoordenadas(int m, int b, int rango1, int rango2);

/**
 * Realiza el llamado de gnuplot para la graficación de la ecuación lineal e immprime la grafica 
 * en el mismo gnuplot.
 * 
 * @brief Imprime en pantalla la grafica de la ecuación lineal con Gnuplot.
 * @author J.Marcos Iturbide
 * @date 23/11/2020
 * @param m Recibe el valor que multiplicara a x
 * @param b Recibe el valor que sumara el resultado multiplicado por x, para la coordenada y
 ...
 * @return void
 */
void graficaLineal(int m, int b, int rango1, int rango2);
